...
def main():
    ...
    print(f"Alphanumeric only (12 chars):  {generate_password(12, use_special=False)}")
    print(f"Letters only (12 chars):       {generate_password(12, use_digits=False, use_special=False)}")
